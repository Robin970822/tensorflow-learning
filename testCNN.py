...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 15 15:03:53 2018
...
W_conv1 = weight_varivable([5, 5, 1, 32])
...
W_conv2 = weight_varivable([5, 5, 32, 64])
b_conv2 = bias_varivable([64])

h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2) + b_conv2)
h_pool2 = max_pool_2x2(h_conv2)

W_fc1 = weight_varivable([7*7*64, 1024])
...
W_fc2 = weight_varivable([1024, 10])
